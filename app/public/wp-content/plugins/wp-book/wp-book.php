 ...
 * @wordpress-plugin
 * Plugin Name:       WP Book
 * Plugin URI:        https://http://localhost/customplugin/wp-book
 * Description:       A plugin for managing a collection of books within WordPress.
 * Version:           1.0.0
 * Author:            Maham Zahid
 * Author URI:        https://http://localhost/customplugin/
 * License:           GPL-2.0+
